#!/bin/bash
# sums two TSV matrices
# args: 1) first TSV, 2) second TSV, 3) output summed TSV
# NB: first column and header must be identical between two input TSVs. Output will be overwritten
# NB: this script also overwrites /tmp/a /tmp/b /tmp/firstCol /tmp/sum
